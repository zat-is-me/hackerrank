...
public class Main {
	...
	public static void main(String[] args) {
		 ...
		 * myListOne.add("ccc"); myListOne.add("aaa"); myListOne.add("ddd");
		 * myListOne.add("aaa"); myListOne.add("aaa");
		 * myListTwo.add("aaa"); myListTwo.add("aaa"); myListTwo.add("aaa");
		 * myListTwo.add("aaa"); myListTwo.add("bbb");
		 * CommonString.commonString(myListOne,myListTwo);
		 */
		
		  String[] queries = new String[] {"qwe","rty","asdfg","pil","qwe","rty","asdfg","poi"}; 
		  String[] strings = new String[] {"asdfg","qwe","rty","qwe","asdfg","qwe","rty","asdfg","poi"};
		  Searching search = new Searching();
		  search.matchingStrings(strings, queries); 
